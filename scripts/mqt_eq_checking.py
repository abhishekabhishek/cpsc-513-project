"""Standalone script to perform equivalence checking on classes of benchmark circuits in mqtbench
...
if __name__ == '__main__':
    ...
    logging.basicConfig(
        filename=f'logs/mqtbench_{id_string}_eq_checking_results.log',
        level=logging.INFO
    )
    ...
    result_df.to_csv(f'results/mqtbench_{id_string}_eq_checking_results.csv')
